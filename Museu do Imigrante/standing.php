                ...
                <div class="banner__wrapper">
                    ...
                    <nav class="banner__breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb__item">
                                <img class="breadcrumb__icon" data-graphics="inline" src="img/chevron-small-right.svg" width="24" height="24" alt="" role="presentation"> <a class="breadcrumb__link" href="inicio.php">Exposições Permantes</a>
                            </li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="exhibit__menu">
                    <ul class="exhibit-menu">
                        <li class="exhibit-menu__item">
                            <a class="exhibit-menu__link" href="#">Gaitas</a>
                        </li>
                        <li class="exhibit-menu__item">
                            <a class="exhibit-menu__link" href="#">Cozinha</a>
                        </li>
                        <li class="exhibit-menu__item">
                            <a class="exhibit-menu__link" href="#">Artes sacras</a>
                        </li>
                        <li class="exhibit-menu__item">
                            <a class="exhibit-menu__link" href="#">Ofícios</a>
                        </li>
                        <li class="exhibit-menu__item">
                            <a class="exhibit-menu__link" href="#">Vinho</a>
                        </li>
                        <li class="exhibit-menu__item">
                            <a class="exhibit-menu__link" href="#">Trabalho</a>
                        </li>
                        <li class="exhibit-menu__item">
                            <a class="exhibit-menu__link" href="#">Quarto</a>
                        </li>
                    </ul>
                </div>
